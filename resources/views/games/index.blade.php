...
@section('content')
    ...
    <div class="row" style="padding:10px;">
        ...
        {{-- Advanced Search --}}
        <form class="form" id="advanced-search" style="width:95%; margin:0 auto;">
            <div class="form-group row">
                ...
                <div class="col-12 pt col-sm-3 col-md-2">
                    <a class="btn btn-secondary" style="width:100%;" data-toggle="collapse" href="#form-advanced">Advanced</a>
                </div>
        ...
        <div class="form-inline" style="width:100%;padding:15px;">
