...
@section('content')
    ...
    @if(Auth::check())
        @section('actionbar-contents')
            ...
            <form method="post" action="{{action("GameController@updateWishlist")}}">
                {{ csrf_field() }}
        ...
        <div class="col-12">
                ...
                @if(Auth::user())
                        ...
                        @endif
                            ...
                            @if(Auth::user()->isIn($game->id, "wishlist"))
                                {!! App\Icon::where("name","Wishlist")->first()->wrap() !!}
                            @endif
                    @endif
                        ...
                        <div style="border:1px solid black;padding:10px;">
                            ...
                            @else
                                <div class="alert alert-info">
                                    <strong>No G2A Match</strong> Manually adding games is currently not
                                    available.
                                </div>
                            @endif
                            <hr>
